package com.androiddevios.simpletabs.secondtab;
...
public class SecondTab extends BaseFragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mCurrenView.setBackgroundColor(Color.GREEN);
		loadTheFragment();
		return mCurrenView;
	}
	...
	private void btnPushClicked() {
		SubSecondTab subTab = new SubSecondTab();
		addFragment(subTab);
	}
